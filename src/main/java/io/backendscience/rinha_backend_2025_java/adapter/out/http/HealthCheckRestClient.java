...
public class HealthCheckRestClient implements HealthCheckGateway {
    ...
    private final Logger logger = Logger.getLogger(HealthCheckRestClient.class.getName());
    ...
    private HealthCheckStatus getHealthCheck(String baseUrl) {
        ResponseEntity<HealthCheckStatus> healthCheckStatusResponse = restClient
                .get()
